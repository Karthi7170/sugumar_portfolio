...
export const projects: ProjectItem[] = [
  {
    ...
    image: '/projects/portrait-story-thumbnail-v2.webp',
    video: '/web-videos/portrait-story.mp4',
    videoType: 'video/mp4',
    poster: '/projects/portrait-story-thumbnail-v2.webp',
    linkLabel: 'PLAY FILM',
    number: '01',
    accent: '#ef8f49'
  },
  {
    ...
    image: '/projects/ride-in-motion-thumbnail-v2.webp',
    video: '/web-videos/ride-in-motion.mp4',
    videoType: 'video/mp4',
    poster: '/projects/ride-in-motion-thumbnail-v2.webp',
    linkLabel: 'PLAY FILM',
    number: '02',
    accent: '#d9533f'
  },
  {
    ...
    image: '/projects/skyone-thumbnail-v2.webp',
    video: '/web-videos/skyone-brand-film.mp4',
    videoType: 'video/mp4',
    poster: '/projects/skyone-thumbnail-v2.webp',
    linkLabel: 'PLAY FILM',
    number: '03',
    accent: '#f1a848'
  },
  {
    ...
    image: '/projects/training-energy-thumbnail-v2.webp',
    video: '/web-videos/training-energy.mp4',
    videoType: 'video/mp4',
    poster: '/projects/training-energy-thumbnail-v2.webp',
    linkLabel: 'PLAY FILM',
    number: '04',
    accent: '#69c8bf'
  },
  {
    ...
    image: '/projects/triumph-road-film-thumbnail-v2.webp',
    video: '/web-videos/triumph-road-film.mp4',
    videoType: 'video/mp4',
    poster: '/projects/triumph-road-film-thumbnail-v2.webp',
    linkLabel: 'PLAY FILM',
    number: '05',
    accent: '#d7b089'
  }
